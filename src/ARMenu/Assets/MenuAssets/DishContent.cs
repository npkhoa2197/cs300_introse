...
public class DishContent{
    ...
    public DishContent(string _dishname, Sprite _image, float _score, string _description, List<string> _options, double _price, int _amount, string _additionalinfo, List<Tuple<string,string> > _comments){
    	dishname = _dishname;
    	image = _image;
    	score = _score;
